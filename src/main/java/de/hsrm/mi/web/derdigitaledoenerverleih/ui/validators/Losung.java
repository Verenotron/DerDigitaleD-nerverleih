...
@Constraint(validatedBy=LosungValidation.class) // Verweis auf Validator-Implementierung
...
public @interface Losung {

    String message() default "Die Losung muss eine 42 oder 'Zweiundvierzig' enthalten";
